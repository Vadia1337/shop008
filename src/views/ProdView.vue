...
export default {
	created(){
		...
		someScript.setAttribute('src', 'assets/js/main.js')
		document.head.appendChild(someScript);

		let someScript2 = document.createElement('script')
		someScript2.setAttribute('src', 'assets/js/slick-custom.js')
		document.head.appendChild(someScript2);
	},
}
</script>
